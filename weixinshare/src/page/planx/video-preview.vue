...
<script>
    ...
    import {getAllActVideoList, setActFocus, setActShareStatus, setLikedHandle, getWxSignature, setVoteHandle, getPageCommentList, createComments, deleteComments, setCommentsLike} from "../../api/index"
    export default {
        name: 'home',
        data() {
        ...
        created() {
            this.videoType = this.$route.params.videoType || 1;
