  ...
  <div class="main">
    ...
    <div class="tab">
      <div class="tab_"
        ...
        <span :class="tab == 1?'video_number':'video_number_unselect'">{{others.length}}</span>
      </div>
      <div class="tab_"
           @click="tabType(2)">
        <div class="rate_video">
    ...
    <div class="join_video"
         v-if="tab == 1">
      <div class="item">
        <div style="position: relative;width: pxTorem(247px);height: pxTorem(356px);"
        ...
        <div>
          <!-- https://act.bomaleye.com/planx_add_video.png -->
      ...
      <div class="item">
        <div style="position: relative;width: pxTorem(247px);height: pxTorem(356px);"
          ...
          <img class="bg"
               src="http://act.bomaleye.com/planx_video_bg.png"
               alt="">
          <div class="like">
            <img src="http://act.bomaleye.com/planx_like.png"
                 alt="">
            <span>{{showTalent.likedCount}}</span>
          </div>
        </div>
        <div>
          <img src="http://act.bomaleye.com/planx_add_video.png"
               class="video"
               @click="showTalentRead"
               v-if="!showTalent.videoUrl"
               alt="">
        </div>
        <!-- <van-uploader v-model="test"
        ...
        <div class="video-list-item"
          ...
          <div class="video-img">
            ...
            <!-- <img class="del"
                 ...
                 @click="delSidelights(item,index)"
...
export default {
  ...
  mounted () {
    window.ocCallAddSpaceVideoAfter = this.ocCallAddSpaceVideoAfter;
    this.$bridge.registerHandler('ocCallAddSpaceVideoAfter', (params, responseCallback) => {
      this.getVideo();
  ...
  methods: {
    ...
    addVideo () {
      let params = {
        ...
        number: this.hearderId
      };
      tools.mobileDetect() == 1 ? window.webkit.messageHandlers.addSpaceVideo.postMessage(params) : this.$bridge.callHandler('addSpaceVideo', params, (res) => { responseCallback(params) })
    },
    showTalentRead () {
      if (tools.sessiongetItem("userType") == 0) {
        Toast('请切换成千里马身份参加活动');
      ...
      if (this.data.relationOfUser == 'PERSONAL_OWNER' || this.data.relationOfUser == 'TEAM_LEADER') {
        this.videoSort = 2;
        this.addVideo();
      }
    ...
    afterRead () {
      ...
      if (this.data.relationOfUser == 'PERSONAL_OWNER' || this.data.relationOfUser == 'TEAM_LEADER' || this.data.relationOfUser == 'TEAM_MEMBER') {
        this.videoSort = 3;
        this.addVideo();
        // 调用APP
      }
