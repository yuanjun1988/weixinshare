           ...
           //展示分享弹窗
            changeShare() {
                let params = {
					...
					link: 'https://mp.bomaleye.com/#/sharePreivew?shareType=1' + '&videoType=' + this.videoType + '&shareVideoId=' + this.videoList[this.current].id, // 分享链接
                    // link: 'http://192.168.0.12935:10000/mp/#/sharePreivew?shareType=1' + '&videoType=' + this.videoType + '&shareVideoId=' + this.videoList[this.current].id,
