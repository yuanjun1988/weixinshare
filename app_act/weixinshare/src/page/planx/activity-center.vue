      ...
      <div class="video-content">
        <div class="content-tab">
          ...
          <div @click="changeTab(2)"
               :class="videoType == 2 ?'m active': ''">
            <span>在校生</span>
            <span class="solid-item"></span>
          </div>
          <div @click="changeTab(3)"
               :class="videoType == 3 ?' active': ''">
            <span>花絮</span>
            <span class="solid-item"></span>
          </div>
        </div>
...
.main {
  ...
  height: auto;
  min-height: 100%;
  background: url(https://act.bomaleye.com/planx_home_bg.png) no-repeat center
    center;
  ...
  .video-content {
    ...
    .video-list {
      ...
      background: url(http://img.bomaleye.com/20210329160152525_663) no-repeat
        center center;
